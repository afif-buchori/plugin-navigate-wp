            ...
            <div class="w-full flex flex-col md:flex-row gap-4 p-4">
                <div class="flex-1">
                    <?php if ($ticket->visitDate->request) { ?>
                        <div class="flex items-center justify-between w-full rounded-full px-4 py-2 gap-4" style="background-color: #dadada;">
                            <input type="date" name="" id="date-package-act<?php echo $idx ?>" min="<?php echo date("Y-m-d") ?>" data-id-ticket="<?php echo $ticket->ticketType[0]->id ?>" class="w-full" placeholder="select date" style="background-color: transparent; height: 30px;">
                        </div>
                    <?php } ?>
                </div>
                ...
                <div id="ticket-type-act" class="flex-1 flex flex-col gap-1" data-ticket="<?php echo count($ticket->ticketType) ?>">
                    <?php foreach ($ticket->ticketType as $key_tick => $tick_type) { ?>
                        <div class="flex items-center justify-between w-full rounded-full px-4 py-2 gap-4" style="background-color: #dadada;" id="new-ticket-type-act" data-qty-package-act='<?= "total-qty-package$idx" ?>' data-date-package-act="date-package-act<?php echo $idx ?>" data-msg-error="<?php echo "msg-error" . $idx ?>" data-qty-act-dec="<?= $idx . "qty-act-dec" . $key_tick ?>" data-qty-type-act="<?= $idx . "qty-type-act" . $key_tick ?>" data-qty-act-inc="<?= $idx . "qty-act-inc" . $key_tick ?>" data-price="<?= $tick_type->price ?>" data-total-price="<?= "total-price" . $idx ?>" data-msg-error="<?php echo "msg-error" . $idx ?>" data-id-btn-submit="<?php echo "submit-package" . $idx ?>" data-modal-quest="<?php echo "modal-question" . $idx ?>" data-close-modal="<?php echo "close-modal-quest" . $idx ?>">
                    ...
                    <div class="flex items-center justify-between w-full rounded-full px-4 py-2 gap-4" style="background-color: #dadada;">
                        <p>Total Price</p>
                        <p class="ml-auto"><?php echo $currency->symbol ?> <span data-digit="<?php echo $currency->digit ?>" id="total-price<?php echo $idx ?>">0</span></p>
                    </div>
                </div>
            </div>
