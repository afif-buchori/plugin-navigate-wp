...
function enx_get_page_content($data)
{
    ...
    $res_activity = $data->activity;
    $data_res = $data->response->data;
                        ...
                        <div class="pt-16 pb-5 xl:py-20">
                            <div class="grid grid-cols-4 gap-2">
                                ...
                                <div class="col-span-1 w-full h-full hidden md:flex flex-col justify-between">
                                    <?php for ($i = 0; $i < 3; $i++) { ?>
                                        <img src="<?php echo $data->imageUrl . $data_res->media[$i] ?>" width="100%"
                                            class="rounded-lg" style="aspect-ratio: 16/9; object-fit: cover;">
                                    <?php } ?>
                                </div>
                            </div>
                            ...
                            <div class="grid grid-cols-4 gap-4 pt-7">
                                <div class="col-span-4 md:col-span-3">
                                    ...
                                    <p class="pl-4"><?php echo $data_res->description ?></p>
                                </div>
                                ...
                                <div class="col-span-1 hidden md:flex flex-col relative">
                                    ...
                                    ">
                                        <p class="mb-2">Start From <span class="font-bold">
                                                ...
                                                <?php echo number_format($data_res->originalPrice, $currency->digit) ?></span>
                                        </p>
