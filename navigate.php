...
if (!class_exists('navigateIdUpdate')) {

  class navigateIdUpdate
  {
    public $plugin_slug;
    public $version;
    public $cache_key;
    ...
    public function __construct()
    {
      ...
      // Tambah filter dan action
      add_filter('plugins_api', array($this, 'info'), 20, 3);
      add_filter('site_transient_update_plugins', array($this, 'update'));
      add_action('upgrader_process_complete', array($this, 'purge'), 10, 2);
    }

    // Fungsi untuk mengambil info.json dari URL
    ...
    // Fungsi untuk menampilkan info plugin
    ...
    // Fungsi untuk mendeteksi pembaruan
