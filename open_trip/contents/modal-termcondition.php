<div id="modal-term-condition-opentrip" style="
    width: 100vw;
    height: 100%;
    position: fixed;
    top: 0;
...
">
    ...
    ">
        <div class="flex justify-between" style="padding-bottom: 8px;">
            ...
            <button id="close-modal-term-condition-opentrip"
                onclick="document.getElementById('modal-term-condition-opentrip').style.display = 'none'" type="button"
        ...
        ">
            <!-- CONTENTS -->
            <div><?php echo $data->termConditions ?></div>
            <!-- END CONTENTS -->
        </div>
